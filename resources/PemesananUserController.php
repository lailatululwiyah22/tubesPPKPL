...
class PemesananUserController extends Controller
{
    ...
    {
        $data = Pengguna::select('id_pengguna','username')->where('id_pengguna', session('id_pengguna'))->get();
        $paket= Paket::select('id_paket','name','durasi','harga','jenis_paket','fasilitas','file')->where('id_paket', 1)->get();
